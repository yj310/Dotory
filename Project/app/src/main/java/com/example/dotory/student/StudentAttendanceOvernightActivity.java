...
public class StudentAttendanceOvernightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_attendance_overnight);
    }
    ...
    public void attendanceOvernightOnClick(View view)
    {
        Intent intent = new Intent(this, StudentAttendanceOvernightActivity.class);
        startActivity(intent);
        finish();
    }
    public void attendanceOndayOnClick(View view)
    {
        Intent intent = new Intent(this, StudentAttendanceOndayActivity.class);
        startActivity(intent);
        finish();
    }
}